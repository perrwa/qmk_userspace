...
Generated by [keymap-drawer](https://github.com/caksoylar/keymap-drawer) — SVGs are auto-updated via CI when YAML sources change. See [`keymap-drawer/`](keymap-drawer/) for per-board SVGs.
